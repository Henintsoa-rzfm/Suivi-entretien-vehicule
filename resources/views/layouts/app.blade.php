...
<html lang="en">
  <head>
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{asset('assets/css/myst.css')}}">
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{asset('images/vam.jpg')}}" />
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo text-light" style="text-decoration: none" href="{{route('dash')}}">S  E  V  D  S  T</a>
          <a class="sidebar-brand brand-logo-mini text-light" style="text-decoration: none" href="{{route('dash')}}">S</a>
        </div>
        <ul class="nav" style="position: fixed">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="{{asset('images/LogoDST.png')}}" alt="">
                  <span class="count bg-success"></span>
                </div>
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">DST</h5>
                  <span>
                    {{Auth::user()->name}}
                  </span>
                </div>
          ...
          @if (Auth::user()->admin)
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('papier')}}">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('dpannes')}}">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{route('contenirs')}}">
              <span class="menu-icon">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{asset('images/LogoDST.png')}}" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">DST</p>
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                  ...
                  <form method="POST" action="{{ route('logout') }}">
                    @csrf
                  <a class="dropdown-item preview-item" href="{{ route('logout') }}" style="text-decoration: none" onclick="event.preventDefault();
                  this.closest('form').submit();">
                    ...
                    <div class="preview-item-content"> 
                      <p class="preview-subject mb-1">{{ __('Déconnexion') }}</p>
                    </div>
                  </form>
                </a>
                </div>
