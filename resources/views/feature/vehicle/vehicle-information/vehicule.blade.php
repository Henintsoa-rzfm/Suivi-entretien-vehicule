...
<div class="d-flex flex-wrap justify-content-between mb-4">
    <div style="flex:1; min-width:200px; margin-bottom:1rem;">
        <p><strong>Plaque :</strong> {{ $vehicule->PlaqueImmatric }}</p>
...
<div class="d-flex flex-wrap gap-3 mb-5">
    <div style="flex:1; min-width:200px; padding:1rem; border:1px solid #eee; border-radius:8px; text-align:center;">
        ...
        @if(isset($vehicule->Visite->Date_exp_Visite))
            ...
            @endphp
            <span class="badge badge-{{ $alertVisite[1] }}">{{ $alertVisite[0] }}</span>
        @else
    ...
    <div style="flex:1; min-width:200px; padding:1rem; border:1px solid #eee; border-radius:8px; text-align:center;">
        ...
        @if(isset($vehicule->Assurance->Date_exp_Assurance))
            ...
            @endphp
            <span class="badge badge-{{ $alertAss[1] }}">{{ $alertAss[0] }}</span>
        @else
            <span class="text-muted">Non renseignée</span>
        @endif
    </div>
    ...
    <tbody>
        @forelse($vehicule->equipements as $equipement)
            ...
            <tr>
                ...
                <td>{{ $kmRelatif >=0 ? $kmRelatif.' KM' : 'Revérifiez' }}</td>
                <td>
